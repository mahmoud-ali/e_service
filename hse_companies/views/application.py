...
class ApplicationMasterDetailUpdateView(LoginRequiredMixin,SingleObjectMixin,View):
    model = None
    form_class = None
    details = []
    success_url = None
...
class ApplicationDeleteMasterDetailView(LoginRequiredMixin,SingleObjectMixin,View):
    model = None
    form_class = None
    details = []
    success_url = None
