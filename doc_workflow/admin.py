...
# class ApplicationDeliveryAdmin(admin.ModelAdmin):
#     # form = TblCompanyCommitmentAdminForm
#     exclude = ["created_at","created_by","updated_at","updated_by"]
    
#     list_display = ["app_record","destination", "created_at", "created_by","updated_at", "updated_by"]        
...
# admin.site.register(ApplicationDelivery, ApplicationDeliveryAdmin)
