...
urlpatterns = [                                                        
    ...
    path('payroll/mokaf2_majlis', Mokaf2MajlisWzara.as_view(), name='payroll_mokaf2_majlis'),
