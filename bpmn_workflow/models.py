...
class ActivityLog(models.Model):
    ...
    EVENT_TYPES = [
        ('process_started', 'بدأت العملية'),
        ('process_completed', 'إكتملت العملية'),
        ('process_terminated', 'Process Terminated'),
        ('process_suspended', 'تم تجميد العملية'),
        ('process_resumed', 'تم فك تجميد العملية'),
        ('task_created', 'تم انشاء مهمة'),
        ('task_assigned', 'تم اسناد مهمة'),
        ('task_started', 'بدأت المهمة'),
        ('task_completed', 'إكتملت المهمة'),
