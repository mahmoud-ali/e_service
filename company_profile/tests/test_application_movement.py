...
from ..views import AppForignerMovementListView

class AppMovementListTests(TestCase):
    view_class = AppForignerMovementListView
    template_name = 'company_profile/application_list.html'
    url_name = 'profile:app_foreigner_list'
    url_path = '/app_foreigner/'
    html_contain = 'List of foreigner movements'
