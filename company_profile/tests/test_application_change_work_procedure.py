...
class AppChangeWorkProcedureTests(ProCompanyTests,TestCase):
    ...
    list_html_contain_en = ['List of procedures/process change']
    ...
    show_html_contain_en = ['Show procedures/process change']
    ...
    add_html_contain_en = ['Add procedures/process change']
