...
class AppBorrowMaterialAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","company_from","company_from_str","borrow_date","recommendation_comments","reject_comments","recommendation_comments","reject_comments","borrow_materials_list_file","borrow_from_approval_file"]
...
class AppBorrowMaterialForm(AppBorrowMaterialAdminForm):
    ...
    class Meta:
        model = AppBorrowMaterial        
        exclude = ["company","state","recommendation_comments","reject_comments","company_from"]
        widgets = {
...
class AppWorkPlanAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppWorkPlan
        fields = ["company","plan_from","plan_to","plan_comments","recommendation_comments","reject_comments","official_letter_file","work_plan_file"] 
...
class AppTechnicalFinancialReportAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","report_type","report_from","report_to","report_comments","recommendation_comments","reject_comments","report_file","other_attachments_file"] 
...
class AppChangeCompanyNameAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","new_name","cause_for_change","recommendation_comments","reject_comments","tasis_certificate_file","tasis_contract_file","sh7_file","lahat_tasis_file","name_change_alert_file"] 
...
class AppExplorationTimeAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","expo_from","expo_to","expo_cause_for_timing","recommendation_comments","reject_comments","expo_cause_for_change_file"] 
...
class AppAddAreaAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppAddArea
        fields = ["company","area_in_km2","cause_for_addition","recommendation_comments","reject_comments","geo_coordination_file"] 
...
class AppRemoveAreaAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppRemoveArea
        fields = ["company","remove_type","area_in_km2","area_percent_from_total","recommendation_comments","reject_comments","geo_coordinator_for_removed_area_file", "geo_coordinator_for_remain_area_file","map_for_clarification_file","technical_report_for_removed_area_file"] 
...
class AppTnazolShrakaAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","tnazol_type","tnazol_for","cause_for_tnazol","recommendation_comments","reject_comments","financial_ability_file", "cv_file","agreement_file"] 
...
class AppTajeelTnazolAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","tnazol_type","cause_for_tajeel","recommendation_comments","reject_comments","cause_for_tajeel_file"]
...
class AppTajmeedAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppTajmeed
        fields = ["company","tajmeed_from","tajmeed_to","cause_for_tajmeed","recommendation_comments","reject_comments","cause_for_uncontrolled_force_file","letter_from_jeha_amnia_file"] 
...
class AppTakhaliAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppTakhali
        fields = ["company","technical_presentation_date","cause_for_takhali","recommendation_comments","reject_comments","technical_report_file"]
...
class AppTamdeedAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppTamdeed
        fields = ["company","tamdeed_from","tamdeed_to","cause_for_tamdeed","recommendation_comments","reject_comments","approved_work_plan_file","tnazol_file"] 
...
class AppTaaweedAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppTaaweed
        fields = ["company","taaweed_from","taaweed_to","cause_for_taaweed","recommendation_comments","reject_comments"] 
...
class AppMdaAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppMda
        fields = ["company","mda_from","mda_to","cause_for_mda","recommendation_comments","reject_comments","approved_work_plan_file"] 
...
class AppChangeWorkProcedureAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","reason_for_change","purpose_for_change","rational_reason","recommendation_comments","reject_comments","study_about_change_reason_file","study_about_new_suggestion_file"] 
...
class AppExportGoldAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        model = AppExportGold
        fields = ["company","total_in_gram","net_in_gram","zakat_in_gram", "awaad_jalila_in_gram","sold_for_bank_of_sudan_in_gram", "amount_to_export_in_gram","remain_in_gram","arbah_amal_in_gram","recommendation_comments","reject_comments", "f1","f3","f4","f6","f7","f8","f9","f5"] 
...
class AppExportGoldRawAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","mineral","license_type","amount_in_gram","sale_price","export_country","export_city","export_address","recommendation_comments","reject_comments", "f11","f12","f13","f14","f15","f16","f17","f18","f19"] 
...
class AppSendSamplesForAnalysisAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","lab_country","lab_city","lab_address","lab_analysis_cost","recommendation_comments","reject_comments","initial_voucher_file","sample_description_form_file","last_analysis_report_file"] 
...
class AppAifaaJomrkiAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","license_type","recommendation_comments","reject_comments", "approved_requirements_list_file", "approval_from_finance_ministry_file","final_voucher_file", "shipping_policy_file","check_certificate_file","origin_certificate_file", "packing_certificate_file","specifications_file","taba_file"] 
...
class AppReexportEquipmentsAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","cause_for_equipments","recommendation_comments","reject_comments", "shipping_policy_file", "voucher_file","specifications_file"] 
...
class AppRequirementsListAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","recommendation_comments","reject_comments", "approved_work_plan_file", "initial_voucher_file","specifications_file", "mshobat_jamarik_file"] 
...
class AppVisibityStudyAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","license_type","study_area", "study_type", "study_comment","recommendation_comments","reject_comments","attachement_file"] 
...
class AppLocalPurchaseAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","recommendation_comments","reject_comments","attachement_file","attachement_file2"] 
...
class AppExplosivePermissionAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","recommendation_comments","reject_comments","attachement_file","attachement_file2","attachement_file3"] 
...
class AppHSEAccidentReportAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","accident_dt","accident_place","accident_type","accident_class","recommendation_comments","reject_comments","attachement_file"] 
...
class AppHSEPerformanceReportAdminForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","license","year","month"] #,"attachement_file"
...
class AppWhomConcernAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","whom_reason","whom_subject","whom_attachement_file","recommendation_comments","reject_comments"] 
        
class AppWhomConcernForm(AppWhomConcernAdminForm):
    company = None
    class Meta:
        model = AppWhomConcern
        exclude = ["company","state","recommendation_comments","reject_comments"] #,"whom_attachement_file"
        widgets = {}
...
class AppGoldProductionAdminForm(WorkflowFormMixin,ModelForm):
    ...
    class Meta:
        ...
        fields = ["company","form_no","attachement_file","recommendation_comments","reject_comments"] 
