# Generated by Django 5.0.1 on 2024-02-07 01:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_profile', '0009_alter_appchangecompanyname_cause_for_change_and_more'),
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'ordering': ['-id'], 'verbose_name': 'Application: Exploration Time', 'verbose_name_plural': 'Application: Exploration Times'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cause_for_addition', models.TextField(max_length=1000, verbose_name='cause_for_addition')),
                ('geo_coordination_file', models.FileField(upload_to=company_profile.models.company_applications_path, verbose_name='geo_coordination_file')),
            ...
            options={
                'verbose_name': 'Application: Add Area',
                'verbose_name_plural': 'Application: Add Area',
                'ordering': ['-id'],
            },
        ),
    ]
