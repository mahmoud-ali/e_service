...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_profile', '0011_appremovearea'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='AppTnazolShraka',
            fields=[
                ...
                ('tnazol_type', models.CharField(choices=[('partial', 'partial'), ('complete', 'complete')], max_length=15, verbose_name='tnazol_type')),
                ('tnazol_for', models.CharField(max_length=200, verbose_name='tnazol_for')),
                ('cause_for_tnazol', models.TextField(max_length=1000, verbose_name='cause_for_tnazol')),
                ('financial_ability_file', models.FileField(upload_to=company_profile.models.company_applications_path, verbose_name='financial_ability_file')),
            ...
            options={
                'verbose_name': 'Application: Tnazol Shraka',
                'verbose_name_plural': 'Application: Tnazol Shraka',
                'ordering': ['-id'],
            },
        ),
    ]
