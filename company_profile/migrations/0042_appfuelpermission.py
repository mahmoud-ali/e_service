...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_profile', '0041_appcyanidecertificate_appexplosivepermission_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='AppFuelPermission',
            fields=[
            ...
            options={
                'verbose_name': 'Application: Fuel Permission',
                'verbose_name_plural': 'Application: Fuel Permission',
                'ordering': ['-id'],
            },
        ),
    ]
