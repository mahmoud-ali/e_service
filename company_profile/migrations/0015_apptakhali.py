...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_profile', '0014_apptajmeed'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technical_presentation_date', models.DateField(verbose_name='technical_presentation_date')),
                ('cause_for_takhali', models.TextField(max_length=1000, verbose_name='cause_for_takhali')),
                ('technical_report_file', models.FileField(upload_to=company_profile.models.company_applications_path, verbose_name='technical_report_file')),
            ...
            options={
                'verbose_name': 'Application: Takhali',
                'verbose_name_plural': 'Application: Takhali',
                'ordering': ['-id'],
            },
        ),
    ]
