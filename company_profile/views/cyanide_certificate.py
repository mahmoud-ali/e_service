...
from ..forms import AppCyanideCertificateForm

from ..workflow import STATE_CHOICES,SUBMITTED,ACCEPTED,APPROVED,REJECTED,send_transition_email,get_sumitted_responsible
from ..tables import AppCyanideCertificateTable

from .application import ApplicationListView, ApplicationCreateView, ApplicationReadonlyView

class AppCyanideCertificateListView(ApplicationListView):
    model = AppCyanideCertificate
    table_class = AppCyanideCertificateTable
    menu_name = "profile:app_cyanide_certificate_list"
    title = _("List of Cyanide Certificates")
...
class AppCyanideCertificateCreateView(ApplicationCreateView):
    model = AppCyanideCertificate
    form_class = AppCyanideCertificateForm
    menu_name = "profile:app_cyanide_certificate_list"
    title = _("Add Cyanide Certificate")
...
class AppCyanideCertificateReadonlyView(ApplicationReadonlyView):
    model = AppCyanideCertificate
    form_class = AppCyanideCertificateForm
    menu_name = "profile:app_cyanide_certificate_list"
    title = _("Show Cyanide Certificate")
