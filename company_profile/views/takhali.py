...
class AppTakhaliCreateView(ApplicationCreateView):
    model = AppTakhali
    form_class = AppTakhaliForm
    menu_name = "profile:app_takhali_list"
    title = _("Add takhali")
    ...
    def form_valid(self, form):
        ...
        self.object.technical_report_file = self.request.FILES["technical_report_file"]
        self.object.save()
...
class AppTakhaliReadonlyView(ApplicationReadonlyView):
    model = AppTakhali
    form_class = AppTakhaliForm
    menu_name = "profile:app_takhali_list"
    title = _("Show takhali")
