...
class AppRestartActivityCreateView(ApplicationCreateView):
    model = AppRestartActivity
...
class AppRestartActivityReadonlyView(ApplicationReadonlyView):
    model = AppRestartActivity
    form_class = AppRestartActivityForm
    menu_name = "profile:app_restart_activity_list"
