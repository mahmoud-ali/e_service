...
from ..forms import AppExplosivePermissionForm

from ..workflow import STATE_CHOICES,SUBMITTED,ACCEPTED,APPROVED,REJECTED,send_transition_email,get_sumitted_responsible
from ..tables import AppExplosivePermissionTable

from .application import ApplicationListView, ApplicationCreateView, ApplicationReadonlyView

class AppExplosivePermissionListView(ApplicationListView):
    model = AppExplosivePermission
    table_class = AppExplosivePermissionTable
    menu_name = "profile:app_explosive_permission_list"
    title = _("List of Explosive Permissions")
...
class AppExplosivePermissionCreateView(ApplicationCreateView):
    model = AppExplosivePermission
    form_class = AppExplosivePermissionForm
    menu_name = "profile:app_explosive_permission_list"
    title = _("Add Explosive Permission")
...
class AppExplosivePermissionReadonlyView(ApplicationReadonlyView):
    model = AppExplosivePermission
    form_class = AppExplosivePermissionForm
    menu_name = "profile:app_explosive_permission_list"
    title = _("Show Explosive Permission")
