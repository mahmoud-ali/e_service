...
class AppMdaCreateView(ApplicationCreateView):
    model = AppMda
    form_class = AppMdaForm
    menu_name = "profile:app_mda_list"
    title = _("Add mda")
...
class AppMdaReadonlyView(ApplicationReadonlyView):
    model = AppMda
    form_class = AppMdaForm
    menu_name = "profile:app_mda_list"
    title = _("Show mda")
