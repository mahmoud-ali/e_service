...
from ..models import AppHSEPerformanceReport
...
class AppHSEPerformanceReportCreateView(ApplicationCreateView):
    model = AppHSEPerformanceReport
...
class AppHSEPerformanceReportReadonlyView(ApplicationReadonlyView):
    model = AppHSEPerformanceReport
    form_class = AppHSEPerformanceReportForm
    menu_name = "profile:app_hse_performance_list"
