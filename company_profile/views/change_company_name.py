...
class AppChangeCompanyNameCreateView(ApplicationCreateView):
    model = AppChangeCompanyName
    form_class = AppChangeCompanyNameForm
    menu_name = "profile:app_change_company_name_list"
    title = _("Add new company name")
    ...
    def form_valid(self, form):
        ...
        self.object.tasis_certificate_file = self.request.FILES["tasis_certificate_file"]
        self.object.tasis_contract_file = self.request.FILES["tasis_contract_file"]
        self.object.sh7_file = self.request.FILES["sh7_file"]
        self.object.lahat_tasis_file = self.request.FILES["lahat_tasis_file"]
        self.object.name_change_alert_file = self.request.FILES["name_change_alert_file"]
        self.object.save()
...
class AppChangeCompanyNameReadonlyView(ApplicationReadonlyView):
    model = AppChangeCompanyName
    form_class = AppChangeCompanyNameForm
    menu_name = "profile:app_change_company_name_list"
