    ...
    try:
        ...
        data = {
            'employee': {
                'code': employee.code,
                'name': employee.name,
                'draja_wazifia': str(employee.get_draja_wazifia_display()) if employee.draja_wazifia else '',
                'alawa_sanawia': str(employee.get_alawa_sanawia_display()) if employee.alawa_sanawia else '',
                ...
                'gasima': 'نعم' if employee.gasima else 'لا',
                'atfal': employee.atfal,
                'moahil': employee.get_moahil_display(),
                'phone': employee.phone,
                'email': employee.email,
                'no3_2lertibat': employee.get_no3_2lertibat_display(),
                'sanoat_2lkhibra': str(employee.sanoat_2lkhibra) if employee.sanoat_2lkhibra else '',
                'aadoa': 'نعم' if employee.aadoa else 'لا',
