...
Create a modern, bilingual (Arabic RTL + English) Django web application that extends the Django admin interface with a custom frontend portal for employee self-service and management workflows. 
